...
@Component
public class HJWTTokenProvider {
    ...
    public String generateJwtToken(HotelierPrincipal hotelierPrincipal){
        String[] claims = getClaimsFromUser(hotelierPrincipal);
        return JWT.create().withIssuer(ADB_CONSTRUCTION_LTD)
                .withAudience(ADB_CONSTRUCTION_ADMINISTRATION)
                .withIssuedAt(new Date())
                .withSubject(hotelierPrincipal.getUsername())
    ...
    private String[] getClaimsFromUser(HotelierPrincipal hotelier) {
        List<String> authorities = new ArrayList<>();
        for (GrantedAuthority grantedAuthority: hotelier.getAuthorities()){
