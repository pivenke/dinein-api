...
public class ExceptionHandling {
    ...
    @ExceptionHandler(FoodItemNotFoundByHotelierAndName.class)
    public ResponseEntity<HttpResponse> foodItemNotFoundByHotelierAndName(FoodItemNotFoundByHotelierAndName exception){
        LOGGER.error(exception.getMessage());
        return createHttpResponse(HttpStatus.BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(ItemAlreadyExistException.class)
    public ResponseEntity<HttpResponse> itemAlreadyExistException(ItemAlreadyExistException exception){
        LOGGER.error(exception.getMessage());
        return createHttpResponse(HttpStatus.BAD_REQUEST, exception.getMessage());
    }

    @ExceptionHandler(RestaurantNotFoundException.class)
    public ResponseEntity<HttpResponse> restaurantNotFoundException(RestaurantNotFoundException exception){
        LOGGER.error(exception.getMessage());
        return createHttpResponse(HttpStatus.BAD_REQUEST, exception.getMessage());
    }
